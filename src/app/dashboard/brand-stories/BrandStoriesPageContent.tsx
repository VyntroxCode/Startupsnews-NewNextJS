...
// This module-level assignment (and the `react-pdf` import above) is why this file is loaded via
// `next/dynamic` from `page.tsx` instead of directly: react-pdf's setup throws in this
// environment, and a dynamic import defers evaluating this file's code until the component is
// actually rendered — which only happens once `BRAND_STORIES_LOCKED` is false. See page.tsx.
...
export default function BrandStoriesPageContent() {
