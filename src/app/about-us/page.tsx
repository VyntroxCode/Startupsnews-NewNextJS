 ...
 * video thumbnail below. Heading fades up first; each paragraph then slides in on its own,
 * alternating from the left and right so the block doesn't read as one flat animation. */
...
function OfferingsSection() {
	...
	return (
		<section ref={ref} className="px-5 md:px-10 py-12 sm:py-16 lg:py-20">
...
export default function AboutPage() {
	return (
		<div className="bg-white py-2">
			<div
				className="max-w-[1200px] mx-auto my-6 sm:my-10 bg-white text-au-ink"
