            ...
            <div className="kt-row-column-wrap" style={{ maxWidth: "1200px", margin: "0 auto", padding: "60px 20px" }}>
                ...
                <section style={{ maxWidth: "900px", margin: "0 auto 80px", textAlign: "justify" }}>
                    ...
                    <p style={{
                        ...
                        If you have a tip, a correction, or a story you think we should be covering, reach us at{" "}
                        <a href="mailto:editorial@startupnews.fyi" style={{ color: "#0077b5", textDecoration: "none" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "30px" }} className="team-grid">
                    ...
                    <div className="team-card" style={{ background: "#fff", padding: "40px", borderRadius: "12px", boxShadow: "0 10px 40px rgba(0,0,0,0.05)" }}>
                        <div style={{ marginBottom: "20px" }}>
                            ...
                            <a href="https://www.linkedin.com/in/madhurmohanmalik/" style={{ color: "#0077b5", fontSize: "20px" }}><LinkedInIcon aria-hidden="true" /></a>
                        </div>
                    ...
                    <div className="team-card" style={{ background: "#fff", padding: "40px", borderRadius: "12px", boxShadow: "0 10px 40px rgba(0,0,0,0.05)" }}>
                        <div style={{ marginBottom: "20px" }}>
                            ...
                            <a href="https://www.linkedin.com/in/kapil-suri-3986307/" target="_blank" rel="noopener noreferrer" style={{ color: "#0077b5", fontSize: "20px" }} aria-label="Kapil Suri on LinkedIn"><LinkedInIcon aria-hidden="true" /></a>
                        </div>
                        <p style={{ fontSize: "13px", lineHeight: "1.6", color: "#333", fontStyle: "italic" }}>
