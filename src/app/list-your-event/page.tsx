...
export const metadata: Metadata = {
  ...
  description:
    "Hosting a meetup, founder session, workshop, hackathon, or startup event? List your event details on StartupNews.fyi and reach founders, entrepreneurs, investors, and the wider startup community.",
  alternates: { canonical: `${SITE_URL}/list-your-event` },
  openGraph: {
    title: "List Your Event – StartupNews.fyi",
    description:
      "Share your startup event details and get featured on StartupNews.fyi's Events page.",
    url: `${SITE_URL}/list-your-event`,
  ...
  return (
    <div className="snf-page" id="snf-root">
      <div className="ribbon-row">
        <div className="ribbon">List Your Event</div>
