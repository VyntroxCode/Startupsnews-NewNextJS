/**
 * Migrate all posts from "AI" category (id=16) to "AI & Deeptech" category (id=117)
 *
 * Run:
 *   npx tsx scripts/migrate-ai-posts.ts --dry-run
 *   npx tsx scripts/migrate-ai-posts.ts --apply
 */
...
const SOURCE_CATEGORY_ID = 16; // AI
